...
var images = ['background.png', 'background2.png', 'background3.png'];
...
window.setTimeout(function () {
        ...
        iframe.setAttribute('src', 'https://www.mixcloud.com/widget/iframe/?light=1&feed=%2Ftapetown%2Fasiriunh-tapetownlive-21052020%2F');
    }, 3000); 

window.setTimeout(function () {
        var iframe = document.getElementById('mix2');
        iframe.setAttribute('src', 'https://www.mixcloud.com/widget/iframe/?light=1&feed=%2Ftapetown%2Fzima-tapetownlive-21052020%2F');
    }, 3000);

window.setTimeout(function () {
        var iframe = document.getElementById('mix3');
        iframe.setAttribute('src', 'https://www.mixcloud.com/widget/iframe/?light=1&feed=%2Ftapetown%2Fwerfol-tapetownlive-16052020%2F');
    }, 3000);
...
//     $('body').css('background-image', 'url(/assets/img/background_phone.png)');
//     $('<img/>').attr('src', '/assets/img/background_phone.png').on('load', function() {
//   $(this).remove(); // prevent memory leaks as @benweet suggested
//   $('body').css('background-image', 'url(assets/img/background_phone.png)');
//  });
//   } else {
//     $('body').css('background-image', 'url(/assets/img/background.png)');
//     $('<img/>').attr('src', '/assets/img/background.png').on('load', function() {
//   $(this).remove(); // prevent memory leaks as @benweet suggested
//   $('body').css('background-image', 'url(assets/img/background.png)');
//  });
//   }
